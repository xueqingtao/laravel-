    ...
    <div class="leftpanel">
        ...
        <div class="leftpanelinner">
            ...
            <ul class="nav nav-pills nav-stacked nav-bracket">
                <li class="active"><a href="{{ \Route::has($menu['url']) ? route($menu['url']): "#"}}"><i class="fa fa-home"></i> <span>首页</span></a></li>
                ...
                <li class="nav-parent"><a href=""><i class="fa fa-edit"></i> <span>列表</span></a>
                    <ul class="children">
                        <li><a href="{{ \Route::has($menu['url']) ? route($menu['url']): "#"}}"><i class="fa fa-caret-right"></i> 列表页面</a></li>
                    </ul>
                </li>
            </ul>
